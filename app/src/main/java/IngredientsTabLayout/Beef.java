...
public class Beef extends Fragment {
    ...
    //Elements Variables
    LinearLayout layout_beef_fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.generate_fragment_beef, container, false);
        layout_beef_fragment = rootView.findViewById(R.id.layout_beef_fragment);
        ...
        CheckboxesDataName beefCheckboxesDataName = new CheckboxesDataName();
        String[] beefList = beefCheckboxesDataName.getBeefIngredientsList();
        for(int i = 0; i < beefList.length; i++) {
            CheckBox checkBox = new CheckBox(requireContext());
            checkBox.setText(beefList[i]);
            ...
            if (i < beefList.length - 1) {
                ...
                layout_beef_fragment.addView(divider);
            }
