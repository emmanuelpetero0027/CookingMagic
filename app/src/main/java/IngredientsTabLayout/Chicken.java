...
public class Chicken extends Fragment {
    ...
    //Elements Variables
    LinearLayout layout_chicken_fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.generate_fragment_chicken, container, false);
        layout_chicken_fragment = rootView.findViewById(R.id.layout_chicken_fragment);
        ...
        CheckboxesDataName chickenCheckboxesDataName = new CheckboxesDataName();
        String[] chickenList = chickenCheckboxesDataName.getChickenIngredientsList();
        for(int i = 0; i < chickenList.length; i++) {
            CheckBox checkBox = new CheckBox(requireContext());
            checkBox.setText(chickenList[i]);
            ...
            if (i < chickenList.length - 1) {
                ...
                layout_chicken_fragment.addView(divider);
            }
