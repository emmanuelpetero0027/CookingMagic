...
public class Fish extends Fragment {
    ...
    //Elements Variables
    LinearLayout layout_fish_fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.generate_fragment_fish, container, false);
        layout_fish_fragment = rootView.findViewById(R.id.layout_fish_fragment);
        ...
        CheckboxesDataName fishCheckboxesDataName = new CheckboxesDataName();
        String[] fishList = fishCheckboxesDataName.getFishIngredientsList();
        for(int i = 0; i < fishList.length; i++) {
            CheckBox checkBox = new CheckBox(requireContext());
            checkBox.setText(fishList[i]);
            ...
            layout_fish_fragment.addView(checkBox);
            ...
            if (i < fishList.length - 1) {
                ...
                layout_fish_fragment.addView(divider);
            }
