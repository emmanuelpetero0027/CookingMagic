...
public class Fruits extends Fragment {
    //Elements Variables
    LinearLayout layout_fruits_fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.generate_fragment_fruits, container, false);
        layout_fruits_fragment = rootView.findViewById(R.id.layout_fruits_fragment);
        ...
        CheckboxesDataName fruitsCheckboxesDataName = new CheckboxesDataName();
        String[] fruitsList = fruitsCheckboxesDataName.getFruitsIngredientsList();
        for(int i = 0; i < fruitsList.length; i++) {
            CheckBox checkBox = new CheckBox(requireContext());
            checkBox.setText(fruitsList[i]);
            ...
            layout_fruits_fragment.addView(checkBox);
            ...
            if (i < fruitsList.length - 1) {
                ...
                layout_fruits_fragment.addView(divider);
            }
