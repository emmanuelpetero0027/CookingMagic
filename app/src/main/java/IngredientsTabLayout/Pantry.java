...
public class Pantry extends Fragment {
    ...
    //Elements Variables
    LinearLayout layout_pantry_fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.generate_fragment_pantry, container, false);
        layout_pantry_fragment = rootView.findViewById(R.id.layout_pantry_fragment);
        ...
        CheckboxesDataName pantryCheckboxesDataName = new CheckboxesDataName();
        String[] pantryList = pantryCheckboxesDataName.getPantryIngredientsList();
        for(int i = 0; i < pantryList.length; i++) {
            CheckBox checkBox = new CheckBox(requireContext());
            checkBox.setText(pantryList[i]);
            ...
            if (i < pantryList.length - 1) {
                ...
                layout_pantry_fragment.addView(divider);
            }
