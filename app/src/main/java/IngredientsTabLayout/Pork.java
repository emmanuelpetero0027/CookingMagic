...
public class Pork extends Fragment {
    //Elements Variables
    LinearLayout layout_pork_fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.generate_fragment_pork, container, false);
        layout_pork_fragment = rootView.findViewById(R.id.layout_pork_fragment);
        ...
        CheckboxesDataName porkCheckboxesDataName = new CheckboxesDataName();
        String[] porkList = porkCheckboxesDataName.getPorkIngredientsList();
        for(int i = 0; i < porkList.length; i++) {
            CheckBox checkBox = new CheckBox(requireContext());
            checkBox.setText(porkList[i]);
            ...
            if (i < porkList.length - 1) {
                ...
                layout_pork_fragment.addView(divider);
            }
