...
public class Sauces extends Fragment {
    //Elements Variables
    LinearLayout layout_sauces_fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.generate_fragment_sauces, container, false);
        layout_sauces_fragment = rootView.findViewById(R.id.layout_sauces_fragment);
        ...
        CheckboxesDataName sauceCheckboxesDataName = new CheckboxesDataName();
        String[] saucesList = sauceCheckboxesDataName.getSaucesIngredientsList();
        for(int i = 0; i < saucesList.length; i++) {
            CheckBox checkBox = new CheckBox(requireContext());
            checkBox.setText(saucesList[i]);
            ...
            if (i < saucesList.length - 1) {
                ...
                layout_sauces_fragment.addView(divider);
            }
