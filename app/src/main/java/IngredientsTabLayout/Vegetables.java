...
public class Vegetables extends Fragment {
    //Elements Variables
    LinearLayout layout_vegetables_fragment;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        View rootView = inflater.inflate(R.layout.generate_fragment_vegetables, container, false);
        layout_vegetables_fragment = rootView.findViewById(R.id.layout_vegetables_fragment);
        ...
        CheckboxesDataName vegetablesCheckboxesDataName = new CheckboxesDataName();
        String[] vegetablesList = vegetablesCheckboxesDataName.getVegetableIngredientList();
        for(int i = 0; i < vegetablesList.length; i++) {
            CheckBox checkBox = new CheckBox(requireContext());
            checkBox.setText(vegetablesList[i]);
            ...
            layout_vegetables_fragment.addView(checkBox);

            // Add divider (horizontal line) after each checkbox, except the last one
            if (i < vegetablesList.length - 1) {
                ...
                layout_vegetables_fragment.addView(divider);
            }
